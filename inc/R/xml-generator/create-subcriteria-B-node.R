...
B1.variable <- with(assess.spa,newXMLNode("Key-indicator-variable",
children=list(newXMLNode("Key-indicator",attrs=list(name="EOO"),
...
newXMLNode("Values",attrs=list(method="Mapped distribution"),children=list(
newXMLNode("Value",children=list(
 newXMLNode("Indicator-value",attrs=list(units="km2"), ">50000")
)))))),
newXMLNode("Collapse-threshold",attrs=list(units="km2"),"0"))
))))
...
B2.variable <- with(assess.spa,newXMLNode("Key-indicator-variable",attrs=list(name="Percentage tree cover"),
...
newXMLNode("Value",attrs=list(method="decline"),children=list(
 newXMLNode("Indicator-value",attrs=list(units="10x10km cells"), ">50")
 )))))),
 newXMLNode("Collapse-threshold",attrs=list(units="km2"),"0"))
 ))))
...
B2.summary <- newXMLNode("Summary",attrs=list(lang="en"),sprintf("We considered presence of trees (as closed forest or woodlands) as a characteristic element and the main indicator of spatial distribution of the macrogroup. Threat defined locations and threatening processes were assesed qualitatively.  %s", B2.rationale))
